...
export const metadata = {
  ...
  description:
    "Holistic beauty and wellness services including hair care, nail care, and massage therapy in a peaceful Cleveland setting.",
};
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="md:col-span-2">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <Image
                    ...
                    className="transition-transform duration-300 group-hover:scale-105"
                  />
                  <span className="text-xl font-[Cormorant_Garamond] text-white">
                    Timeless Perfection
                  </span>
                </div>
                <p className="text-sm text-gray-200 leading-relaxed max-w-md">
                  Modern beauty care meets timeless wellness practices.
                  Experience personalized treatments designed to restore
                  balance, reduce stress, and promote your natural beauty.
                </p>
              </div>

              <div>
                <h5 className="font-semibold mb-4 text-brand-yellow">
                  Services
                </h5>
              ...
              <div>
                ...
                <div className="text-sm text-gray-200 space-y-2">
                  ...
                  <div className="pt-2">
                    <a
                      href="mailto:hello@anzawellness.com"
                      className="hover:text-brand-yellow transition-colors"
                    >
